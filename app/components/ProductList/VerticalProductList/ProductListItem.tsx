...
const VerticalProductListItem: React.FC<VerticalProductListItemProps> = ({
    ...
    return (
        <li className='flex flex-col items-start justify-start bg-white p-4 rounded-md gap-[6px] min-h-[20rem] max-w-[16rem] min-w-[16rem] relative' data-testid="product-list-item">
